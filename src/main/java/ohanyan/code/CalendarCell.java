...
import ohanyan.controllers.CalendarController;
...
public class CalendarCell<S, T> extends TableCell<S, T> {
    ...
    protected void updateItem(T item, boolean empty) {
        ...
        if (item != null) {
            ...
            mi1.setOnAction(event -> new CalendarController(dBconnection).updateCalendarCell((CalendarCell<CalendarController.Months, String>) this, event));
            mi2.setOnAction(event -> new CalendarController(dBconnection).updateCalendarCell((CalendarCell<CalendarController.Months, String>) this, event));
    ...
    private static boolean checkDateForWeekEnd(int month, int day) {
        System.out.println("checkDateForWeekEnd");
    ...
    public boolean checkDateForHoliday(int month, int day) {
        System.out.println("checkDateForHoliday");
        ...
        try {
            while (res.next()) {
                ...
                System.out.println("yyyy: " + yyyy + "; " + "mm: " + mm + "; " + "dd: " + dd + "; " + "type: " + type);
    ...
    public boolean checkDateForWorkday(int month, int day) {
        System.out.println("checkDateForWorkday");
        setBeforeFirst();
        try {
            while (res.next()) {
                int yyyy = res.getInt(CalendarController.YEAR);
